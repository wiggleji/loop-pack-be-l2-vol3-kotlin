...
interface UserV1ApiSpec {
    ...
    fun getMyInfo(@LoginUser user: User): ApiResponse<UserV1Dto.UserResponse>
    ...
    fun changePassword(@LoginUser user: User, request: UserV1Dto.UserChangePasswordRequest): ApiResponse<Any>
}
